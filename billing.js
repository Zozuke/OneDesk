/* =====================================================================
   ...
   -----------------------------------------------------------------
   Ahora el estado de "trial / activo / vencido" vive en la tabla
   `profiles` de Supabase (columna subscription_status), actualizada
   automáticamente por el webhook de Stripe (supabase/functions/
   stripe-webhook). Este archivo ya NO decide el estado — solo lo LEE
   y muestra la interfaz correspondiente.

   El botón "Activar plan" llama a la Edge Function stripe-checkout,
   que crea una sesión de pago real y redirige al usuario a Stripe.
   ===================================================================== */
